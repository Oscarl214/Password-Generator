...
function generatePassword() {
  ...
  while (
    passwordLength <= 7 ||
    passwordLength >= 129 ||
    isNaN(passwordLength) //if User were to input anything that is not a number
  ) {
    alert(
  ...
  alert(`Your password length will be ${passwordLength}`);
  ...
  //selectedArray(set of characters)[index of selectedArray.length * random argument]
